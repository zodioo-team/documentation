...
e-mail MTA server settings. One for transactional e-mails and one for mass mail servers. 
Make sure you give the priority to the transactional server over the server for the mass email.
